...
class write_FBD_files():
    ...
    def write_script(self, interval_ages, min_age):
        ...
        if self.translate is not None or min_age > 0.0:
            rho = 0.0
        if self.FBD_rate_prior == 'HSMRF' and self.padding[0] == np.inf and self.padding[1] == 0.0:
            ...
            scrfile.write('q()')
            scrfile.flush()
        elif self.FBD_rate_prior == 'HSMRF':
            scr = "%s/%s/%s/%s/%s_FBDR_HSMRF.Rev" % (self.output_wd, self.name_file, 'FBD', 'scripts', self.name_file)
            scrfile = open(scr, "w")
            scrfile.write('######################################')
            scrfile.write('\n')
            ...
            scrfile.write('    }')
            scrfile.write('\n')
            scrfile.write('    speciation[i] := exp(log_speciation_at_present - cumdiff_sp) + 0.0001')
            scrfile.write('\n')
            scrfile.write('}')
            scrfile.write('\n')
            ...
            scrfile.write('    }')
            scrfile.write('\n')
            scrfile.write('    speciation[timeline_size_before + 1 + i] := exp(log_speciation_at_present + cumsum_sp) + 0.0001')
            scrfile.write('\n')
            scrfile.write('}')
            scrfile.write('\n')
            scrfile.write('\n')
            ...
            scrfile.write('    }')
            scrfile.write('\n')
            scrfile.write('    extinction[i] := exp(log_extinction_at_present - cumdiff_ex) + 0.0001')
            scrfile.write('\n')
            scrfile.write('}')
            scrfile.write('\n')
            ...
            scrfile.write('    }')
            scrfile.write('\n')
            scrfile.write('    extinction[timeline_size_before + 1 + i] := exp(log_extinction_at_present + cumsum_ex) + 0.00001')
            scrfile.write('\n')
            scrfile.write('}')
            scrfile.write('\n')
            scrfile.write('\n')
            ...
            scrfile.write('    }')
            scrfile.write('\n')
            scrfile.write('    psi[i + 1] := exp(log_psi_at_present - cumdiff_psi) + 0.00001')
            scrfile.write('\n')
            scrfile.write('}')
            scrfile.write('\n')
            ...
            scrfile.write('    }')
            scrfile.write('\n')
            scrfile.write('    psi[timeline_size_before + 1 + i] := exp(log_psi_at_present + cumsum_psi) + 0.00001')
            scrfile.write('\n')
            scrfile.write('}')
            scrfile.write('\n')
            scrfile.write('psi[psi.size() + 1] = 0.00001')
            scrfile.write('\n')
            scrfile.write('\n')
            scrfile.write('# Move all field parameters in one go')
            scrfile.write('\n')
            ...
            scrfile.write('monitors.append(mnScreen(speciation, extinction, psi, printgen = 5000))')
            scrfile.write('\n')
            scrfile.write('monitors.append(mnModel(filename="output/TruncExtended_model1_HSMRF.log", printgen = 50))')
            scrfile.write('\n')
            scrfile.write('\n')
            scrfile.write('# monitors to print RevGagets input')
            scrfile.write('\n')
            scrfile.write('monitors.append(mnFile(filename="output/TruncExtended_model1_HSMRF_speciation_rates.log", speciation, printgen = 50))')
            scrfile.write('\n')
            scrfile.write('monitors.append(mnFile(filename="output/TruncExtended_model1_HSMRF_speciation_times.log", timeline, printgen = 50))')
            scrfile.write('\n')
            scrfile.write('monitors.append(mnFile(filename="output/TruncExtended_model1_HSMRF_extinction_rates.log", extinction, printgen = 50))')
            scrfile.write('\n')
            scrfile.write('monitors.append(mnFile(filename="output/TruncExtended_model1_HSMRF_sampling_rates.log", psi, printgen = 50))')
            scrfile.write('\n')
            scrfile.write('monitors.append(mnFile(filename="output/TruncExtended_model1_HSMRF_ts_te.log", bd, printgen = 50))')
            scrfile.write('\n')
            scrfile.write('\n')
            scrfile.write('# run the analysis')
            scrfile.write('\n')
            scrfile.write('mymcmc = mcmc(mymodel, moves, monitors, nruns = 1, moveschedule = "random")')
            scrfile.write('\n')
