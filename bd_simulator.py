...
class write_FBD_files():
    ...
    def write_script(self, interval_ages):
        ...
        if self.FBD_rate_prior == 'HSMRF':
            ...
            scrfile.write('\n')
            scrfile.write('speciation_global_scale_hyperprior <- 0.044')
            scrfile.write('\n')
            scrfile.write('extinction_global_scale_hyperprior <- 0.044')
            scrfile.write('\n')
            ...
            scrfile.write('# create a random variable at the present time')
            scrfile.write('\n')
            scrfile.write('log_speciation_at_present ~ dnUniform(-10.0, 10.0)')
            scrfile.write('\n')
            scrfile.write('log_speciation_at_present.setValue(0.0)')
            scrfile.write('\n')
            scrfile.write('log_extinction_at_present ~ dnUniform(-10.0, 10.0)')
            scrfile.write('\n')
            ...
            scrfile.write('\n')
            scrfile.write('speciation := fnassembleContinuousMRF(log_speciation_at_present, delta_log_speciation, initialValueIsLogScale = TRUE, order = 1)')
            scrfile.write('\n')
            scrfile.write('extinction := fnassembleContinuousMRF(log_extinction_at_present, delta_log_extinction, initialValueIsLogScale = TRUE, order = 1)')
            scrfile.write('\n')
            scrfile.write('\n')
